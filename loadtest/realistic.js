...
export function handleSummary(data) {
  ...
  console.log(`Jogadores entraram: ${data.metrics.players_joined?.values?.count || 0}`);
  console.log(`Respostas enviadas: ${data.metrics.answers_submitted?.values?.count || 0}`);
  console.log("==============================================\n");
